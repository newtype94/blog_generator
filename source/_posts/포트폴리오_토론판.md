...
<img src="/image/toronpan/mypage.jpg" width="30%" title="30px" alt="마이페이지"></img>

## 운영 플랫폼(서비스 종료)
  PC, Mobile 하이브리드 : www.toronpan.net
...
아래 사진들은 실제 서버를 임대하고 도메인을 구입해 연동한 기록이다.
...
## 차별점
1. 어떤 사안에 대해 찬성, 반대(진보, 보수)로 나누어지면 
상대측의 댓글 목록을 볼 수는 있지만 
좋아요나 대댓글을 달 수 없다.
=> 상대측의 정리된 의견을 볼 수 있다.
